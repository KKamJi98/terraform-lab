...
| [aws_eks_addon.post](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eks_addon) | resource |
...
| <a name="input_addons"></a> [addons](#input\_addons) | EKS addons configuration | <pre>map(object({<br/>    addon_version               = optional(string)<br/>    configuration_values        = optional(string)<br/>    preserve                    = optional(bool)<br/>    resolve_conflicts_on_create = optional(string)<br/>    resolve_conflicts_on_update = optional(string)<br/>    after_core                  = optional(bool, false)<br/>    pod_identity_association = optional(list(object({<br/>      role_arn        = string<br/>      service_account = string<br/>    })), [])<br/>    tags = optional(map(string), {})<br/>  }))</pre> | `{}` | no |
